...
1. Download `Reco-Trainer-Mac-0.12.11.dmg`.
...
1. Download and extract `Reco.Trainer.Windows.0.12.11.zip`.
...
1. Download and extract `Reco.Trainer.Linux.0.12.11.zip`.
...
1. Download and extract `Reco.Trainer.Docker.0.12.11.zip`.
...
- `RELEASE-NOTES-0.12.11.md` — changes, installation details and SHA-256 checksums.
