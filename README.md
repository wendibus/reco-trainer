...
1. Download `Reco-Trainer-Mac-0.13.1.dmg`.
...
1. Download and extract `Reco.Trainer.Windows.0.13.1.zip`.
...
1. Download and extract `Reco.Trainer.Linux.0.13.1.zip`.
...
1. Download and extract `Reco.Trainer.Docker.0.13.1.zip`.
...
- `RELEASE-NOTES-0.13.1.md` — changes, installation details and SHA-256 checksums.
