...
1. Download `Reco-Trainer-Mac-0.14.1.dmg`.
...
1. Download and extract `Reco.Trainer.Windows.0.14.1.zip`.
...
1. Download and extract `Reco.Trainer.Linux.0.14.1.zip`.
...
1. Download and extract `Reco.Trainer.Docker.0.14.1.zip`.
...
- `RELEASE-NOTES-0.14.1.md` — changes, installation details and SHA-256 checksums.
