...
1. Download `Reco-Trainer-Mac-0.14.2.dmg`.
...
1. Download and extract `Reco.Trainer.Windows.0.14.2.zip`.
...
1. Download and extract `Reco.Trainer.Linux.0.14.2.zip`.
...
1. Download and extract `Reco.Trainer.Docker.0.14.2.zip`.
...
- `RELEASE-NOTES-0.14.2.md` — changes, installation details and SHA-256 checksums.
