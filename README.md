...
1. Download `Reco-Trainer-Mac-0.12.15.dmg`.
...
1. Download and extract `Reco.Trainer.Windows.0.12.15.zip`.
...
1. Download and extract `Reco.Trainer.Linux.0.12.15.zip`.
...
1. Download and extract `Reco.Trainer.Docker.0.12.15.zip`.
...
- `RELEASE-NOTES-0.12.15.md` — changes, installation details and SHA-256 checksums.
